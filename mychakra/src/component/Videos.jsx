  ...
  const [videoSrc, setVideoSrc] = useState(videosArr[0])
    ...
    return(
       <Stack direction={['column', 'row']} h={'100vh'}>
        <VStack w={'full'}>
          <video controls controlsList="nodownloaded" src={videoSrc }style={{width: '100%'}}></video>
          <VStack alignContent={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
            <Heading>Sample video 1</Heading>
            <Text>This is the sample video for Testting and demo. this is called description</Text>
          </VStack>
        </VStack>
